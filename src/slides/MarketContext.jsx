  ...
  return (
    <div style={{ maxWidth:1100, margin:'0 auto', padding:'0 4px' }}>
      <div style={{ marginBottom:24 }}>
        ...
        <h1 style={{ fontSize:'clamp(1.8rem,3.5vw,2.8rem)', fontWeight:900, color:'#F5F0E8', marginBottom:8, textTransform:'uppercase', letterSpacing:'-0.01em', lineHeight:1.1 }}>Investment Case & Market Positioning</h1>
