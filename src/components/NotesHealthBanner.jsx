...
// Founder-only top banner — see src/hackney/components/NotesHealthBanner.jsx
// for the sibling rationale. Surfaces hydrate-guard trips and empty-backend
// states before any investor save can clobber data.
    ...
    <div style={{
      ...
      <div style={{ flex:1 }}>
        ...
        <div style={{ marginTop:6, fontSize:10, color:'#FCA5A5', opacity:0.75 }}>
          Recovery: open the Borough workbook → File · Version history. The
