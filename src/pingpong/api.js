// No Dice ping-pong-tournament API — talks to the `pingpong` Supabase edge function.
// All actions are founder-gated by SEND_SECRET (the /ops "Ping Pong" screen).
import { SUPABASE_URL, SEND_SECRET } from '../marketing/data/backend.js'

const FN_URL = `${SUPABASE_URL}/functions/v1/pingpong`
...
export const tournNextRound = (runId, force) => call({ action: 'generateNextRound', runId, force })
