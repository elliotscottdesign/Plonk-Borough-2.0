...
// (no i18n). Numbers/copy will be filled in once final figures land.
...
export default function Cover() {
  ...
  const stats = [
    { label: 'Seeking',                value: `${fmt(DEAL.investment)} inc VAT`,    sub: '50% equity · 50% retained by founder' },
    { label: '2025 Verified Revenue',  value: fmt(ACTUALS_2025.revenue),            sub: 'Real bar-only trading history — not a projection' },
    { label: 'Year 1 Investor Return', value: fmt(DEAL.investorDividend),           sub: `${cocPct}% cash-on-cash · payback ${payback} yrs` },
    ...
    { label: 'Valuation Entry',        value: `${DEAL.multiple.toFixed(2)}×`,        sub: 'EBITDA · below 4.1× hospitality sector average' },
  ]
