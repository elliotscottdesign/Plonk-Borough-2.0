...
// signs. The page is personalised with Lee's name + £1k figure but the
// substantive clauses are the template every investor sees (identical
// to the LeonieAgreement template).
//
...
//   • £1,000 cash subscription = 1 share = 1% equity
//   • NO preferred yield class — every share entitled to the same £X
//     per-share dividend declared by the directors + A-share holders
  ...
  return (
    <div style={{ padding:'32px 48px', maxWidth:1100, margin:'0 auto', color:CREAM, lineHeight:1.6 }}>
      ...
      <Section number="4" title="Per-share dividend &amp; distribution waterfall">
        <P>
          Dividends are declared by the directors as a <strong style={{ color:GOLD }}>£X per share</strong>. The Company has issued 100 shares in total; every share (A or B) is entitled to the same per-share amount when a dividend is declared. There is <strong style={{ color:CREAM }}>no preferred class</strong> — the Investor's payout for each window = his shares held × the per-share rate declared.
        </P>
        <P>
          The Investor holds <strong style={{ color:CREAM }}>1 B-class share</strong>. If, for example, the directors declare £851.81 per share at the Y1 review (the indicative base-case figure), the Investor receives <strong style={{ color:CREAM }}>1 × £851.81 = £852</strong>; the Founder (76 A-class shares) receives 76 × £851.81 = £64,738.
        </P>
        <P>
      ...
      <Section number="6" title="Year-3 Founder Buyback Right (Call Option, market rate)">
        <P>
          The <strong style={{ color:CREAM }}>Founder</strong> is granted the right, exercisable in the 30-day window following the issue of the Year-3 audited (or director-certified) accounts, to require the Investor to sell all (but not part) of his B shares back to the Company.
        </P>
        <P>
        ...
        <P>
          If the Investor has elected to convert his Round 1 B shares into Round 2 equity (where Round 2 is offered), his shares are <strong style={{ color:CREAM }}>not callable</strong> under this clause — the Founder's call right falls away.
        </P>
        <P>
          <strong style={{ color:GOLD }}>Cumulative dividends paid up to the exercise date are not clawed back.</strong> The Investor keeps everything he has already received in Y1–Y3 distributions, on top of the buyback price.
        </P>
      </Section>
      ...
      <Section number="9" title="Future rounds · pre-emption rights">
        ...
        <P style={{ fontSize:12, color:CREAM_D, fontStyle:'italic', marginTop:14 }}>
          Practical effect: a Shareholder who does not exercise his pre-emption right within 14 days sees his share count remain unchanged but his percentage of the enlarged share capital shrinks proportionally to the new issuance. The per-share dividend entitlement continues on his existing shares without alteration. The Founder's call right at clause 6 is unchanged — if exercised, the Investor exits before any Round 2 mechanics become relevant for him.
        </P>
      </Section>
      ...
      <Section number="12" title="Sale event · Year-5 exit · tag &amp; drag">
        ...
        <P>
          <strong style={{ color:CREAM }}>Tag-along.</strong> If the Founder proposes to sell any A shares to a third party, the Investor has the right to tag his B shares into the same sale on the same per-share terms, pro-rata to his holding.
        </P>
      </Section>
